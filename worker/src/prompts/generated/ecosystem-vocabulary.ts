...
export const PACK_NAMES = ["cloudflare-edge-platform", "gaming-lounge", "home-maintenance", "network-observatory", "product-operations-starter", "saas-revenue-ops", "speculator", "stallari-core", "stallari-hearth", "groupthink-operations", "stallari-sysadmin"] as const;
